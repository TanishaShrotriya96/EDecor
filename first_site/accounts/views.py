...
class LogInView(GuestOnlyView, FormView):
    ...
    def get_form_class(**kwargs):
        if settings.DISABLE_USERNAME or settings.LOGIN_VIA_EMAIL:
            #currently only LOGIN_VIA_EMAIL is enabled as true
    ...
    #method_decorator is used to wrap extra functionalities to a function
    #general syntax : 
    '''
    def a(c):
        def b(d):
    ...
    @method_decorator(csrf_protect)#csrf is the name of the extra decoration to be added to dispatch
