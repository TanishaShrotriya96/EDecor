...
#inherits SignIn
#not used currently because variable in Settings.py not set
...
#inherits SignIn
#used currently  because variable in Settings.py is set to True
...
#inherits UserCacheMixin, forms.Form
